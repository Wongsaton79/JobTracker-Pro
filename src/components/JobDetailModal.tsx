          ...
          <div className="flex items-center gap-2">
            {onDirectSendLine && (
              <button
                ...
                title="กดส่งการ์ด Flex Message เข้ากลุ่ม LINE ทันที"
              >
                <Send className="w-3.5 h-3.5" />
                <span>ส่ง LINE Flex เข้ากลุ่ม</span>
              </button>
            )}
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-2 bg-white hover:bg-slate-100 text-slate-700 border border-slate-300 rounded-xl text-xs font-medium transition-colors"
            >
